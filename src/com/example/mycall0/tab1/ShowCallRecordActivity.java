...
public class ShowCallRecordActivity extends Activity {
	...
	private Button call_goback;
	private Button call_ok1;
	private Button call_choose_all;
	private Button call_cancle1;
	private Button call_delete1;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		callLogListView = (ListView) findViewById(R.id.show_call_record);
		button = (Button) ShowCallRecordActivity.this
				.findViewById(R.id.call_choose_all);
		bottomout1 = (LinearLayout) ShowCallRecordActivity.this
				.findViewById(R.id.show_call_out1);
		bottomout2 = (LinearLayout) ShowCallRecordActivity.this
				.findViewById(R.id.show_call_out2);
		call_goback = (Button) ShowCallRecordActivity.this
				.findViewById(R.id.call_goback);
		call_ok1 = (Button) ShowCallRecordActivity.this
				.findViewById(R.id.call_ok1);
		call_choose_all = (Button) ShowCallRecordActivity.this
				.findViewById(R.id.call_choose_all);
		call_cancle1 = (Button) ShowCallRecordActivity.this
				.findViewById(R.id.call_cancle1);
		call_delete1 = (Button) ShowCallRecordActivity.this
				.findViewById(R.id.call_delete);
	...
	public void onClick(View v) {
		switch (v.getId()) {
		case R.id.call_goback: {
			ShowCallRecordActivity.this.finish();
			break;
		}
	...
	private void deletePart() {
		...
		ContentResolver resolver = ShowCallRecordActivity.this
				.getContentResolver();
		for (int i = 0; i < strid.size(); i++) {
	...
	public void checkShowBox() {
		if (!showBox) {
			setAllInvisibility();
			bottomout1.setVisibility(View.VISIBLE);
			call_goback.setClickable(true);
			call_delete1.setClickable(true);
			call_choose_all.setClickable(true);
			bottomout2.setVisibility(View.INVISIBLE);
			call_cancle1.setClickable(false);
			call_ok1.setClickable(false);
		} else {
			setAllVisibility();
			bottomout1.setVisibility(View.INVISIBLE);
			call_goback.setClickable(false);
			call_delete1.setClickable(false);
			call_choose_all.setClickable(false);
			bottomout2.setVisibility(View.VISIBLE);
			call_cancle1.setClickable(true);
			call_ok1.setClickable(true);
		}
	}
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.show_call_record, menu);
		return true;
	}
	...
	private void setAdapter(List<CallLogBean> callLogs) {
		adapter = new DialAdapter(ShowCallRecordActivity.this, callLogs);

...
public class ShowIncommingActivity extends Activity {
	...
	private Button show_incomming_goback;
	private Button show_incomming_ok1;
	private Button show_incomming_choose_all;
	private Button show_incomming_cancle1;
	private Button show_incomming_delete1;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_show_incomming);
		callLogListView = (ListView) findViewById(R.id.show_incomming);
		choose_all = (Button) ShowIncommingActivity.this
				.findViewById(R.id.show_incomming_choose_all);
		bottomout1 = (LinearLayout) ShowIncommingActivity.this
				.findViewById(R.id.show_incomming_out1);
		bottomout2 = (LinearLayout) ShowIncommingActivity.this
				.findViewById(R.id.show_incomming_out2);
		show_incomming_goback = (Button) ShowIncommingActivity.this
				.findViewById(R.id.show_incomming_goback);
		show_incomming_ok1 = (Button) ShowIncommingActivity.this
				.findViewById(R.id.show_incomming_ok1);
		show_incomming_choose_all = (Button) ShowIncommingActivity.this
				.findViewById(R.id.show_incomming_choose_all);
		show_incomming_cancle1 = (Button) ShowIncommingActivity.this
				.findViewById(R.id.show_incomming_cancle1);
		show_incomming_delete1 = (Button) ShowIncommingActivity.this
				.findViewById(R.id.show_incomming_delete);
	...
	public void onClick(View v) {
		switch (v.getId()) {
		case R.id.show_incomming_goback: {
			ShowIncommingActivity.this.finish();
			break;
		}
		case R.id.show_incomming_delete: {
			showBox = true;
			setAllVisibility();
			checkShowBox();
			break;
		}
		case R.id.show_incomming_choose_all: {
			showBox = true;
			checkShowBox();
			setAllVisibility();
			setAllYes();
		...
		case R.id.show_incomming_cancle1: {
			showBox = false;
			setAllNo();
			checkShowBox();
			break;
		}
		case R.id.show_incomming_ok1: {
			deletePart();
			showBox = false;
			setAllNo();
			checkShowBox();
	...
	private void deletePart() {
		...
		ContentResolver resolver = ShowIncommingActivity.this
				.getContentResolver();
		for (int i = 0; i < strid.size(); i++) {
	...
	public void checkShowBox() {
		if (!showBox) {
			setAllInvisibility();
			bottomout1.setVisibility(View.VISIBLE);
			show_incomming_goback.setClickable(true);
			show_incomming_delete1.setClickable(true);
			show_incomming_choose_all.setClickable(true);
			bottomout2.setVisibility(View.INVISIBLE);
			show_incomming_cancle1.setClickable(false);
			show_incomming_ok1.setClickable(false);
		} else {
			setAllVisibility();
			bottomout1.setVisibility(View.INVISIBLE);
			show_incomming_goback.setClickable(false);
			show_incomming_delete1.setClickable(false);
			show_incomming_choose_all.setClickable(false);
			bottomout2.setVisibility(View.VISIBLE);
			show_incomming_cancle1.setClickable(true);
			show_incomming_ok1.setClickable(true);
		}
	}
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.show_incomming, menu);
		return true;
	}
	...
	private void setAdapter(List<CallLogBean> callLogs) {
		adapter = new DialAdapter(ShowIncommingActivity.this, callLogs);

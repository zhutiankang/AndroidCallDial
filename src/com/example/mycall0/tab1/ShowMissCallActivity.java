...
public class ShowMissCallActivity extends Activity {
	...
	private Button choose_all_bn;

	private LinearLayout bottomout1;
	private LinearLayout bottomout2;
	private Button show_miss_goback;
	private Button show_miss_ok1;
	private Button show_miss_choose_all;
	private Button show_miss_cancle1;
	private Button show_miss_delete1;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_show_miss_call);
		choose_all_bn = (Button) ShowMissCallActivity.this
				.findViewById(R.id.show_miss_choose_all);
		bottomout1 = (LinearLayout) ShowMissCallActivity.this
				.findViewById(R.id.show_miss_out1);
		bottomout2 = (LinearLayout) ShowMissCallActivity.this
				.findViewById(R.id.show_miss_out2);
		show_miss_goback = (Button) ShowMissCallActivity.this
				.findViewById(R.id.show_miss_goback);
		show_miss_ok1 = (Button) ShowMissCallActivity.this
				.findViewById(R.id.show_miss_ok1);
		show_miss_choose_all = (Button) ShowMissCallActivity.this
				.findViewById(R.id.show_miss_choose_all);
		show_miss_cancle1 = (Button) ShowMissCallActivity.this
				.findViewById(R.id.show_miss_cancle1);
		show_miss_delete1 = (Button) ShowMissCallActivity.this
				.findViewById(R.id.show_miss_delete);
		strid = new ArrayList<Integer>();
		bottomout1.setVisibility(View.VISIBLE);
		callLogListView = (ListView) findViewById(R.id.show_miss_call);
	...
	public void onClick(View v) {
		switch (v.getId()) {
		case R.id.show_miss_goback: {
			ShowMissCallActivity.this.finish();
			break;
		}
		case R.id.show_miss_delete: {
			showBox = true;
			setAllVisibility();
			checkShowBox();
			break;
		}
		case R.id.show_miss_choose_all: {
			showBox = true;
			checkShowBox();
			setAllVisibility();
			setAllYes();
		...
		case R.id.show_miss_cancle1: {
			showBox = false;
			setAllNo();
			checkShowBox();
			break;
		}
		case R.id.show_miss_ok1: {
			deletePart();
			showBox = false;
			setAllNo();
			checkShowBox();
	...
	private void deletePart() {
		...
		ContentResolver resolver = ShowMissCallActivity.this
				.getContentResolver();
		for (int i = 0; i < strid.size(); i++) {
	...
	public void checkShowBox() {
		if (!showBox) {
			setAllInvisibility();
			bottomout1.setVisibility(View.VISIBLE);
			show_miss_goback.setClickable(true);
			show_miss_delete1.setClickable(true);
			show_miss_choose_all.setClickable(true);
			bottomout2.setVisibility(View.INVISIBLE);
			show_miss_cancle1.setClickable(false);
			show_miss_ok1.setClickable(false);
		} else {
			setAllVisibility();
			bottomout1.setVisibility(View.INVISIBLE);
			show_miss_goback.setClickable(false);
			show_miss_delete1.setClickable(false);
			show_miss_choose_all.setClickable(false);
			bottomout2.setVisibility(View.VISIBLE);
			show_miss_cancle1.setClickable(true);
			show_miss_ok1.setClickable(true);
		}
	}
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.show_miss_call, menu);
		return true;
	}
	...
	private void setAdapter(List<CallLogBean> callLogs) {
		adapter = new DialAdapter(ShowMissCallActivity.this, callLogs);

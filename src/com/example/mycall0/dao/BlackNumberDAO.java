package com.example.mycall0.dao;
...
public class BlackNumberDAO {
	...
	public List<BlackNumberInfo> findAll() {
		...
		SQLiteDatabase db = helper.getReadableDatabase();
		Cursor cursor = db
				.rawQuery("select number from blacknumber order by _id desc", null);
	...
	public List<BlackNumberInfo> findPart(int offset,int maxnumber) {
		...
		SQLiteDatabase db = helper.getReadableDatabase();
		Cursor cursor = db
				.rawQuery("select number from blacknumber order by _id desc limit ? offset ?", 
